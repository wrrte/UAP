...
attack_types = ["MNDTS"] 
mus = [0.9, 0.95, 1.0]              # 모멘텀(mu) 튜닝 추가: 1.0을 기준으로 미세 조정
number_of_si_scales_list = [1]     # 최고점을 달성한 1로 고정하여 탐색 시간 단축
di_probs = [0.35, 0.4, 0.45]                   # 82.61점의 최고 효율을 낸 0.4로 고정
di_pad_amounts = [28, 29, 30, 31]      # mu 변화에 따른 영향을 보기 위해 28, 31, 34 유지
di_pad_values = [0]
ti_kernel_sizes = [1,  3]           # 최적화가 완료된 커널 사이즈 (1, 3 유지)
feature_attacks = [True]     # 대망의 Feature Attack 활성화 및 비활성화 테스트
depths = ['layer4']       # (Tip: 'layer3'로 바꿔보는 것도 전이성에 큰 도움이 될 수 있습니다)
# ======================================================
